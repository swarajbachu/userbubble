  ...
  return (
    <div className="relative flex min-h-80 flex-col items-start justify-end overflow-hidden rounded-2xl bg-black p-4 md:p-8">
      <div className="relative z-40 mb-2 flex items-center gap-2">
        <p className="rounded-md bg-black/50 px-2 py-1 text-white text-xs">
          Product Company
        </p>
        <p className="rounded-md bg-black/50 px-2 py-1 text-white text-xs">
          Cloud Management
      ...
      <div className="-top-48 -right-40 mask-r-from-50% absolute z-20 grid rotate-45 transform grid-cols-4 gap-32">
      ...
      <div className="-top-0 -right-10 mask-r-from-50% absolute z-20 grid rotate-45 transform grid-cols-4 gap-32 opacity-50">
        <div className="size-40 shrink-0 rounded-3xl bg-neutral-900 shadow-[0px_2px_0px_0px_var(--color-neutral-600)_inset]" />
        <div className="size-40 shrink-0 rounded-3xl bg-neutral-900 shadow-[0px_2px_0px_0px_var(--color-neutral-600)_inset]" />
        <div className="size-40 shrink-0 rounded-3xl bg-neutral-900 shadow-[0px_2px_0px_0px_var(--color-neutral-600)_inset]" />
        <div className="size-40 shrink-0 rounded-3xl bg-neutral-900 shadow-[0px_2px_0px_0px_var(--color-neutral-600)_inset]" />
