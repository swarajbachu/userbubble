...
export const Card = ({
  ...
  return (
    ...
    >
      ...
      <div className="-top-1.5 absolute inset-x-0 mx-auto size-3 rounded-full border-2 border-gray-300 bg-white dark:border-neutral-700 dark:bg-neutral-900" />

      <motion.div
        className="relative z-20 flex w-54 shrink-0 flex-col items-start rounded-lg bg-white shadow-aceternity dark:bg-neutral-900"
